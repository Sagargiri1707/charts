export const data = [
    ...
    {school:"Slow-Munroe Falls HS",fees:2300, population:7070 ,location:"LA ",males:5000  ,females:	2070,clubs:"Music,Math"},
...
export const location = data.map(d => d.location)
export const clubs = ['Music,Math','Music',"Math","Dance","Dance,Math","Dance,Music","Dance,Music,Math"]
